 ...
 */
 ...
 class makeReservations {
   ...
   public function __construct() {
     ...
     $this->define( 'MAKERES_ABSPATH', dirname( MAKESF_PLUGIN_FILE ) . '/' );
  ...
  private function includes() {
       include_once MAKERES_ABSPATH . 'inc/api-endpoints.php';
  }
...
function makeres_install() {
    return null;
}

register_activation_hook( __FILE__, 'makeres_install' );
